        ...
        <div class="container">
            <div class="svg-wrraper">
                <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 500 500">
                    ...
                    <g id="freepik--background-complete--inject-5">
                        ...
                        <polygon class="shp14" points="215.28 175.12 275.07 182.83 272.26 118.13 215.28 175.12"></polygon>
                        <polygon class="shp4" points="215.28 175.12 272.26 175.12 272.26 118.13 215.28 175.12"></polygon>
                        <path class="shp10"
                    ...
                    <g id="freepik--Shadow--inject-5">
                        <ellipse class="shp15" id="freepik--path--inject-5" cx="250" cy="416.24" rx="193.89"
                            ry="11.32"></ellipse>
                    </g>
                    <g id="freepik--character-1--inject-5">
                        ...
                        <polygon class="shp11" points="74.53 389.66 80.42 393.77 90.58 377.21 84.69 373.1 74.53 389.66">
                        </polygon>
                        <path class="shp2"
                        ...
                        <polygon class="shp3" points="90.57 377.21 85.34 385.75 79.03 382.31 84.69 373.1 90.57 377.21">
                        </polygon>
                        <path class="shp0"
                        ...
                        <path class="shp16" d="M161.66,154.42a18.53,18.53,0,0,0,3.21,3.81,2.91,2.91,0,0,1-2.3.91Z"></path>
                        <path class="shp2"
                    ...
                    <g id="freepik--character-2--inject-5">
                        ...
                        <path class="shp3" d="M366.71,191.37c.13,7.28,5.41,18.91,11.35,24.81.36-6.15.59-12.82.77-19.55Z">
                        </path>
                        <path class="shp7"
                        ...
                        <path class="shp2"
                            d="M367.79,125.49c1.53-7.08-16.34-10.74-22-2.47C343.87,128,366.71,132.4,367.79,125.49Z"></path>
                        <path class="shp2"
                    ...
                    <g id="freepik--page-not-found--inject-5">
                        <rect class="shp4" x="130.06" y="37.96" width="239.88" height="57.52" rx="8.42"></rect>
                        <path class="shp2"
            ...
            <div class="col-md-8 offset-md-2">
                ...
                <p class="sub-content">The page you are attempting to reach is currently not available. This may be because
                    the page does not exist or has been moved.</p><a class="btn btn-primary"
                    href="{{ route('dashboard') }}">BACK TO HOME PAGE</a>
            </div>
        </div>
    </div>
@endsection
