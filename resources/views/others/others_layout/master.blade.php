...
<head>
    ...
    <link rel="icon" href="{{ asset('assets/images/SALONUNITII LOGO-02 3.svg') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('assets/images/SALONUNITII LOGO-02 3.svg') }}" type="image/x-icon">
