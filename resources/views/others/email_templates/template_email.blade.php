                                    ...
                                    <div class="product-box hover">
                                        ...
                                        <div class="product-info">
                                            <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star"
                                                ...
                                                <h6 style="text-align: center;">Single Seater Chair</h6>
                                            </a>
                                            <h4 style="text-align: center;">$50.00</h4>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="product-box hover">
                                        ...
                                        <div class="product-info">
                                            <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star"
                                                    ...
                                                    style="color:#e6c830;"></i></div><a href="javascript:void(0)"
                                                tabindex="0" style="text-align: center;">
                                                <h6 style="text-align: center;">Indikasa Eilish Arm Chair</h6>
                                            </a>
                                    ...
                                    <div class="product-box hover">
                                        ...
                                        <div class="product-info">
                                            <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star"
                                                    ...
                                                    style="color:#e6c830;"></i></div><a href="javascript:void(0)"
                                                tabindex="0" style="text-align: center;">
                                                <h6 style="text-align: center;">Teak Wood Rocking Chair</h6>
                                            </a>
                                            <h4 style="text-align: center;">$60.00</h4>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                                    ...
                                    <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr class="temp-social">
                                                <td><a href="https://www.facebook.com"><i class="fa fa-facebook"></i></a>
                                                </td>
                                                ...
                                                <td><a href="https://www.linkedin.com"><i class="fa fa-linkedin"> </i></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
