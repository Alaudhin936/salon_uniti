...
@section('email_body')
    ...
    <body style="margin: 20px auto; ">
        <table align="center" border="0" cellpadding="0" cellspacing="0"
            style="border-radius:10px;; background-color: #fff; -webkit-box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);box-shadow: 0px 0px 14px -4px rgba(0, 0, 0, 0.2705882353);">
            <tbody>
                <tr>
                    <td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="h2-white left pb20"
                                                        style="color:#ffffff; font-family: work-Sans, sans-serif; font-size:52px; line-height:58px; text-transform:uppercase; font-weight:bold; text-align:left; padding-bottom:20px;">
                                                        new <br>season</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <p style="font-size:13px;color:#4e54cb;text-align:left;color:#fff;">
                                                            We are committed to your satisfaction with every order.</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="product-box hover" style="margin:15px;">
                                            <div class="product border-theme br-0"><img class="img-fluid"
                                                    src="{{ asset('assets/images/email-template/7.jpg') }}" alt="product"
                                    ...
                                    <td>
                                        <div class="product-box hover" style="margin:15px;">
                                            <div class="product border-theme br-0"><img class="img-fluid"
                                                    src="{{ asset('assets/images/email-template/8.jpg') }}" alt="product"
                                                    style="border-radius:10px;;"></div>
                                            <div class="product-info">
                                                <div class="rating" style="margin-bottom:5px;"><i class="fa fa-star"
                                                        style="color:#e6c830;"></i><i class="fa fa-star"
                            ...
                            <tbody>
                                <tr class="add-with-banner" align="center">
                                    <td><a href="javascript:void(0)"><img class="img-fluid"
                                                src="{{ asset('assets/images/email-template/banner.jpg') }}"
                                                alt="product" style="width: 100%; border-radius:10px;;"></a></td>
                                </tr>
                            </tbody>
                        </table>
                        <table border="0" cellpadding="0" cellspacing="0" align="center" style="margin-top:30px;">
                            <tbody>
                                <tr>
                                    <td><img class="img-fluid"
                                            src="{{ asset('assets/images/email-template/banner-2.jpg') }}" alt=""
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                            ...
                            <tbody>
                                <tr>
                                    <td align="center">
                                        <table class="display-width-inner" align="center" border="0" cellpadding="0"
                                            cellspacing="0" width="100%" style="max-width:450px;">
                                            <tbody>
                                                <tr>
                                                    <td class="img-sec" align="center" style="width: 40%; "><img
                                                            src="{{ asset('assets/images/email-template/10.jpg') }}"
                                                            alt=""
                                                            style="width: 225px;margin-bottom: -4px; border-top-left-radius:10px;">
                                                    </td>
                                                    <td align="center"
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="img-sec" align="center" style="width: 40%;"><img
                                                            ...
                                                            alt="" style="width: 225px;margin-bottom: -4px;"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table class="display-width-inner" align="center" border="0" cellpadding="0"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="img-sec" align="center" style="width: 40%; "><img
                                                            src="{{ asset('assets/images/email-template/12.jpg') }}"
                                                            alt=""
                                                            style="width: 225px;margin-bottom: -4px; border-bottom-left-radius:10px;">
                                                    </td>
                                                    <td align="center"
                                        ...
                                        <table class="footer-social-icon" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tbody>
                                                <tr class="temp-social">
                                                    ...
                                                    <td><a href="https://www.youtube.com/PLAY"><i
                                                                class="fa fa-youtube-play"></i></a></td>
                                                    <td><a href="https://twitter.com/"><i class="fa fa-twitter"></i></a>
                                                    </td>
                                                    <td><a href="https://www.google.com/"><i
                                                                class="fa fa-google-plus"></i></a></td>
                                                    <td><a href="https://in.linkedin.com/"><i class="fa fa-linkedin">
                                                            </i></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
