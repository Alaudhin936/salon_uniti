                                        ...
                                        <td>
                                            <div class="d-flex"><img class="img-fluid align-top circle"
                                                ...
                                                <div class="flex-grow-1"><a
                                                        href="{{ route('user_profile') }}"><span>Ossim keter</span></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex"><img class="img-fluid align-top circle"
                                                ...
                                                <div class="flex-grow-1"><a
                                                        href="{{ route('user_profile') }}"><span>Venter loren</span></a>
                                                    <p class="mb-0">Now</p>
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex"><img class="img-fluid align-top circle"
                                                ...
                                                <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span>Fran
                                                            loain</span></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex"><img class="img-fluid align-top circle"
                                                ...
                                                <div class="flex-grow-1"><a
                                                        href="{{ route('user_profile') }}"><span>Loften Horen</span></a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex"><img class="img-fluid align-top circle"
                                                ...
                                                <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span>Loie
                                                            fenter</span></a>
                                                    <p class="mb-0">2 Day After</p>
                                                </div>
                                                <div class="active-status active-offline"></div>
