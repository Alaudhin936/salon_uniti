          ...
          <div class="card-body">
            <div class="row gy-4">
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-primary"><i class="icofont icofont-arrow-down font-primary"></i></div>
                    <div class="flex-grow-1">
                      <h6>Today</h6>
                      <h5>$<span class="counter">25698</span><span class="font-primary ms-2">-36%($2658)</span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-secondary"><i class="icofont icofont-arrow-down font-secondary"></i></div>
                    <div class="flex-grow-1">
                      <h6>Month</h6>
                      <h5>$<span class="counter">6954</span><span class="font-secondary ms-2">-15%($369)                               </span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    ...
                    <div class="flex-grow-1">
                      <h6>Week</h6>
                      <h5>$63147<span class="font-success ms-2">+65%($69)</span></h5>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-info"><i class="icofont icofont-arrow-up font-info"></i></div>
                    <div class="flex-grow-1">
                      <h6>Year</h6>
                      <h5>$96318<span class="font-info ms-2">+90%($364)</span></h5>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card-body">
            <div class="row gy-4">
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    ...
                    <div class="flex-grow-1">
                      <h6>New Order</h6>
                      <h5>6981<span class="font-primary ms-2"><i class="icofont icofont-arrow-up mt-2"></i></span><span class="font-primary f-w-700">68%</span></h5>
                      <div class="icon-bg">
                ...
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-secondary">
                      <svg class="fill-secondary" width="98" height="98" viewBox="0 0 98 98" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex-grow-1">
                      <h6>Pending  Order</h6>
                      <h5>783<span class="font-secondary ms-2"><i class="icofont icofont-arrow-down"></i></span><span class="font-secondary f-w-700">12%</span></h5>
                      <div class="icon-bg">
                ...
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <h5>$63147<span class="font-success ms-2"><i class="icofont icofont-arrow-up"></i></span><span class="font-success f-w-700">50%</span></h5>
                      <div class="icon-bg">
              ...
              <div class="col-md-6">
                <div class="widget-card">
                  <div class="d-flex align-self-center">
                    <div class="widget-icon bg-light-info">
                      <svg class="fill-info" width="98" height="98" viewBox="0 0 98 98" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex-grow-1">
                      ...
                      <h5>69<span class="font-info ms-2"> <i class="icofont icofont-arrow-up"></i></span><span class="font-info f-w-700">20%</span></h5>
                      <div class="icon-bg">
        ...
        <div class="card custom-profile">
          <div class="card-body">
            ...
            <div class="text-center profile-details">
              <h4> <a href="{{ route('user_profile') }}">James Martin</a></h4>
              <h6>Manager</h6>
            </div>
            <ul class="card-social">
              <li class="bg-fb"><a href="https://www.facebook.com/" data-bs-original-title="" title=""><i class="fa fa-facebook"></i></a></li>
              <li class="bg-gplus"><a href="https://myaccount.google.com/" data-bs-original-title="" title=""><i class="fa fa-google-plus"></i></a></li>
              <li class="bg-twitter"><a href="https://twitter.com/" data-bs-original-title="" title=""><i class="fa fa-twitter"></i></a></li>
              <li class="bg-insta"><a href="https://www.instagram.com/" data-bs-original-title="" title=""><i class="fa fa-instagram"></i></a></li>
              <li class="bg-linkedin"><a href="https://dashboard.rss.com/auth/sign-in/" data-bs-original-title="" title=""><i class="fa fa-rss"></i></a></li>
            </ul>
          </div>
            ...
            <div class="card-body">
              <div class="activity-media">
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    <h6>Any desktop publishing pack ages editors.</h6><span><i class="me-2 align-middle" data-feather="clock"></i><span class="align-middle">25 July 2022 | 20 hours ago</span></span>
                  </div>
                </div>
                <div class="d-flex">
                  ...
                  <div class="flex-grow-1">
                    <h6>
                      ...
                      is not simply.
                    </h6><span><i class="me-2 align-middle" data-feather="clock"></i><span class="align-middle">25 July 2022 | 20 hours ago</span></span>
                  </div>
                </div>
                <div class="d-flex">
                  <div class="recent-circle bg-color-success"></div>
                  <div class="flex-grow-1">
                    <h6>Established fact that a reader will be distracted lorem.</h6><span><i class="me-2 align-middle" data-feather="clock"></i><span class="align-middle">25 July 2022 | 20 hours ago</span></span>
                  </div>
                </div>
                <div class="d-flex">
              ...
              <div class="code-box-copy">
                <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#recent"><i class="icofont icofont-copy-alt"></i></button>
                <pre><code class="language-html" id="recent">&lt;div class="card activity-widget"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;div class="d-flex"&gt;
&lt;div class="flex-grow-1"&gt;
&lt;h4&gt; Recent Activity&lt;/h4&gt;
        ...
        <div class="row">
          <div class="col-xl-12 col-lg-12">
            <div class="card testimonial">
              <div class="card-body"><img class="img-90 user-img" src="{{ asset('assets/images/general-widget/testimonial.png') }}" alt="">
          ...
          <div class="card-body">
            <div class="table-responsive theme-scrollbar mb-0">
              <table class="table">
                ...
                <tbody>
                  <tr>
                    <td><img class="img-fluid" src="{{ asset('assets/images/dashboard/chrom.png') }}" alt=""></td>
                    <td>Google Chrome</td>
                    <td>28%</td>
                    <td>76%</td>
                    <td>36%</td>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="card social-widget-card">
              <div class="card-body">
                <div class="d-flex">
                  <div class="social-font"><img src="{{ asset('assets/images/general-widget/svg-icon/2.svg') }}" alt=""></div>
                  <div class="flex-grow-1">
                    <h4>Facebook</h4>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col text-center">
                    <h6>Posts</h6>
                    <h5 class="counter mb-0 font-primary mt-1">6589</h5>
                  </div>
                  <div class="col text-center">
                    <h6>Likes</h6>
                    <h5 class="counter mb-0 font-primary mt-1">6589</h5>
          ...
          <div class="col-sm-6">
            <div class="card social-widget-card">
              <div class="card-body">
                <div class="d-flex">
                  <div class="social-font"><img src="{{ asset('assets/images/general-widget/svg-icon/3.svg') }}" alt=""></div>
                  <div class="flex-grow-1">
                    <h4>Twitter</h4>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col text-center">
                    <h6>Posts</h6>
                    <h5 class="counter mb-0 font-primary mt-1">920</h5>
                  </div>
                  <div class="col text-center">
                    <h6>Likes</h6>
                    <h5 class="mb-0 font-primary mt-1"> <span class="counter">4</span>k</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6">
            <div class="card social-widget-card">
              <div class="card-body">
                <div class="d-flex">
                  <div class="social-font"><img src="{{ asset('assets/images/general-widget/svg-icon/6.svg') }}" alt=""></div>
                  <div class="flex-grow-1">
                    <h4>Linkedin</h4>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col text-center">
                    <h6>Posts</h6>
                    <h5 class="counter mb-0 font-primary mt-1">1234</h5>
                  </div>
                  <div class="col text-center">
                    <h6>Likes</h6>
                    <h5 class="counter mb-0 font-primary mt-1">4369</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-6">
            <div class="card social-widget-card">
              <div class="card-body">
                <div class="d-flex">
                  <div class="social-font"><img src="{{ asset('assets/images/general-widget/svg-icon/4.svg') }}" alt=""></div>
                  <div class="flex-grow-1">
                    <h4>Instagram</h4>
                  </div>
                </div>
              ...
              <div class="card-footer">
                <div class="row">
                  <div class="col text-center">
                    <h6>Posts</h6>
                    <h5 class="counter mb-0 font-primary mt-1">369</h5>
                  </div>
                  <div class="col text-center">
                    <h6>Likes</h6>
                    <h5 class="counter mb-0 font-primary mt-1">3458</h5>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card-body">
            <div class="table-responsive theme-scrollbar mb-0">
              <table class="table table-bordernone">
                ...
                <tbody>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Dummy text usedout print</a></td>
                    <td>10</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-primary">  Done</span></td>
                  </tr>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Graphic or web designs</a></td>
                    <td>20</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-warning">  Pending</span></td>
                  </tr>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Attributed Passage</a></td>
                    <td>40</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-success">  Done</span></td>
                  </tr>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Unknown typesetter</a></td>
                    <td>05</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-info">  In process</span></td>
                  </tr>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Have scrambled</a></td>
                    <td>08</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-danger">  Pending</span></td>
                  </tr>
                  <tr>
                    <td> <a href="{{ route('product_page') }}">Type specimen</a></td>
                    <td>12</td>
                    <td>$6523</td>
                    <td class="text-end"><span class="badge badge-light-primary">Pending</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#cart"><i class="icofont icofont-copy-alt"></i></button>
              <pre><code class="language-html" id="cart">&lt;div class="card user-status"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;div class="d-flex"&gt;
&lt;div class="flex-grow-1"&gt;
&lt;h4&gt; Product Cart&lt;/h4&gt;
      ...
      <div class="col-xl-6 col-lg-6">
        <div class="card employee-status">
          ...
          <div class="card-body">
            <div class="table-responsive theme-scrollbar">
              <table class="table table-bordernone">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex"><img src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                        <div class="flex-grow-1">
                          <h5> <a href="{{ route('user_cards') }}">John Deo </a><span class="text-muted">(14+ Online)</span></h5>
                        </div>
                      </div>
                    </td>
                    <td>Designer</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex"><img class="img-radius align-top m-r-15 rounded-circle" src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                        <div class="flex-grow-1">
                          <h5> <a href="{{ route('user_cards') }}">Holio Mako </a><span class="text-muted">(250+ Online)</span></h5>
                        </div>
                      </div>
                    </td>
                    <td>Developer</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex"><img class="img-radius align-top m-r-15 rounded-circle" src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                        <div class="flex-grow-1">
                          <h5> <a href="{{ route('user_cards') }}">Mohsib lara</a><span class="text-muted">(99+ Online)</span></h5>
                        </div>
                      </div>
                    </td>
                    <td>Tester</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex"><img src="{{ asset('assets/images/user/6.jpg') }}" alt="">
                        <div class="flex-grow-1">
                          <h5> <a href="{{ route('user_cards') }}">Hileri Soli </a><span class="text-muted">(150+ Online)</span></h5>
                        </div>
                      </div>
                    </td>
                    <td>Designer</td>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex"><img src="{{ asset('assets/images/user/7.jpg') }}" alt="">
                        <div class="flex-grow-1">
                          <h5> <a href="{{ route('user_cards') }}">Pusiz bia </a><span class="text-muted">(14+ Online)</span></h5>
                        </div>
                      </div>
                    </td>
                    <td>Designer</td>
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#status"><i class="icofont icofont-copy-alt"></i></button>
              <pre><code class="language-html" id="status">&lt;div class="card employee-status"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;div class="d-flex"&gt;
&lt;div class="flex-grow-1"&gt;
&lt;h4&gt; Employee Status &lt;/h4&gt;
  ...
  &lt;tr&gt;
    &lt;td&gt;
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          &lt;h5&gt; &lt;a href="user-cards.html"&gt; John deo &lt;/a&gt;
            &lt;span class="text-muted"&gt; (14+ Online) &lt;/span&gt;
          &lt;/h5&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
    ...
    &lt;td&gt;
      &lt;div class="progress-showcase"&gt;
        &lt;div class="progress" style="height:8px;"&gt;
          &lt;div class="progress-bar bg-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 30%;"&gt;
          &lt;/div&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
  ...
  &lt;tr&gt;
    &lt;td&gt;
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          &lt;h5&gt; &lt;a href="user-cards.html"&gt; Holio Mako &lt;/a&gt;
            &lt;span class="text-muted"&gt; (250+ Online) &lt;/span&gt;
          &lt;/h5&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
    ...
    &lt;td&gt;
      &lt;div class="progress-showcase"&gt;
        &lt;div class="progress" style="height:8px;"&gt;
          &lt;div class="progress-bar bg-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 70%;"&gt;
          &lt;/div&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
  ...
  &lt;tr&gt;
    &lt;td&gt;
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          &lt;h5&gt; &lt;a href="user-cards.html"&gt; Mohsib lara &lt;/a&gt;
            &lt;span class="text-muted"&gt; (99+ Online) &lt;/span&gt;
          &lt;/h5&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
    ...
    &lt;td&gt;
      &lt;div class="progress-showcase"&gt;
        &lt;div class="progress" style="height:8px;"&gt;
          &lt;div class="progress-bar bg-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"&gt;
          &lt;/div&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
  ...
  &lt;tr&gt;
    &lt;td&gt;
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          &lt;h5&gt; &lt;a href="user-cards.html"&gt; Hileri Soli &lt;/a&gt;
            &lt;span class="text-muted"&gt; (150+ Online) &lt;/span&gt;
          &lt;/h5&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
  ...
  &lt;tr&gt;
    &lt;td&gt;
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          &lt;h5&gt; &lt;a href="user-cards.html"&gt; Pusiz bia &lt;/a&gt;
            &lt;span class="text-muted"&gt; (14+ Online) &lt;/span&gt;
          &lt;/h5&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    ...
    &lt;td&gt;
      &lt;div class="progress-showcase"&gt;
        &lt;div class="progress" style="height:8px;"&gt;
          &lt;div class="progress-bar bg-primary" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width: 90%;"&gt;
          &lt;/div&gt;
        &lt;/div&gt;
      &lt;/div&gt;
    &lt;/td&gt;
        ...
        <div class="card height-equal">
          <div class="calender-widget">
            ...
            <div class="cal-desc text-center card-body">
              ...
              <p class="mb-0">Denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth,Letraset sheets containing Lorem Ipsum passages, and more recently with desktop Lorem Ipsum is simply.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-body">
            <div class="contact-form">
              <form class="theme-form">
                ...
                <div class="text-sm-end"><a class="btn btn-primary" href="{{ route('contacts') }}">SEND IT</a></div>
              </form>
            </div>
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#contact"><i class="icofont icofont-copy-alt"></i></button>
              <pre><code class="language-html" id="contact">&lt;div class="card"&gt;
&lt;div class="card-header pb-0"&gt;
&lt;div class="d-flex"&gt;
&lt;div class="flex-grow-1"&gt;
&lt;h4&gt; Contact Us&lt;/h4&gt;
...
&lt;div class="mb-3"&gt;
  &lt;label for="exampleInputName"&gt; Your Name &lt;/label&gt;
  &lt;input id="exampleInputName" class="form-control" type="text" placeholder="John Dio"&gt;
&lt;/div&gt;
&lt;div class="mb-3"&gt;
  &lt;label class="col-form-label" for="exampleInputEmail1"&gt; Email &lt;/label&gt;
  &lt;input id="exampleInputEmail1" class="form-control" type="email" placeholder="Demo@gmail.com"&gt;
&lt;/div&gt;
&lt;div class="mb-3"&gt;
  &lt;label class="col-form-label" for="exampleInputEmail1"&gt; Message &lt;/label&gt;
  &lt;input id="exampleInputEmail1" class="form-control" type="text" placeholder="Your Message"&gt;
&lt;/div&gt;
&lt;div class="text-sm-end"&gt;
  &lt;a href="{{ route('dashboard') }}" class="btn btn-primary"&gt; SEND IT &lt;/a&gt;
&lt;/div&gt;
&lt;/form&gt;
&lt;/div&gt;
&lt;/div&gt;
