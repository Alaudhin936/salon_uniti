              ...
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="{{ route('order_history') }}">Delivery processing </a><span class="pull-right">6 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="{{ route('cart') }}">Order Complete</a><span class="pull-right">3 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="{{ route('invoice_template') }}">Tickets Generated</a><span class="pull-right">1 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="{{ route('email_inbox') }}">Delivery Complete</a><span class="pull-right">45 min</span></p>
                  </div>
                </div>
              </li>
