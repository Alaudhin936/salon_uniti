                                            ...
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span
                                                            class="fw-semibold text-dark">{{ \Carbon\Carbon::parse($booking['date'])->format('D, M j, Y') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span class="fw-semibold text-dark">{{ $booking['slot_start'] }} -
                                                            {{ $booking['slot_end'] }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="d-flex align-items-start">
                                                    <div>
                                                        ...
                                                        <span
                                                            class="fw-bold text-success fs-5">₹{{ number_format($service->price, 2) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <form id="paymentForm" action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            @foreach ($paymentTypes as $method)
                                                <div class="col-md-4 col-sm-6">
                                                    <input type="radio" name="payment_method_id"
                                                        ...
                                                        data-name={{ $method->name }} class="d-none payment-method-radio"
                                                        {{ $loop->first ? 'checked' : '' }}>
                                                    ...
                                                    <div class="method-name fw-semibold text-center">{{ $method->name }}
                                                    </div>
                                ...
                                <div class="mb-4 mt-5">
                                    <div id="paymentDetails">
                                        ...
                                        {{-- <div class="payment-detail card-details d-none mt-5" >
                                        <div class="card border-0 bg-light rounded-3">
                                            <div class="card-body p-4">
                                                <h6 class="fw-bold mb-3 text-primary">
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control form-control-lg"
                                                                id="expiry" name="expiry" placeholder="MM/YY"
                                                                maxlength="5">
                                                            <label for="expiry">
                                ...
                                <div class="row g-3 mt-5">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-success btn-lg w-100 py-3 rounded-3 fw-bold">
                                            ...
                                            Confirm Payment ₹{{ number_format($service->price, 2) }}
                                        </button>
                                    </div>
                                    <div class="col-12">
                                        <a href="{{ url()->previous() }}"
