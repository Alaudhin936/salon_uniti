                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Add Bookmark
                                                                </h5>
                                                                ...
                                                                <form class="form-bookmark needs-validation"
                                                                    ...
                                                                    <div class="form-row">
                                                                        <div class="form-group col-md-12">
                                                                            ...
                                                                            <input class="form-control" id="bm-weburl"
                                                                                type="text" required=""
                                                                                autocomplete="off">
                                                                        </div>
                                                                        <div class="form-group col-md-12">
                                                                            <label for="bm-title">Title</label>
                                                                            <input class="form-control" id="bm-title"
                                                                                type="text" required=""
                                                                                autocomplete="off">
                                                                        </div>
                                                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="card-body pb-0">
                                                <div class="details-bookmark text-center">
                                                    <div class="row" id="bookmarkData">
                                                        <div
                                                            class="col-xxl-3 col-xl-4 col-lg-3 col-md-4 col-sm-6 box-col-4">
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            ...
                                                                            <div class="content-general">
                                                                                <p class="desc_0">Tivo is beautifully
                                                                                    crafted, clean and modern designed admin
                                                                                    template with 6 different demos and
                                                                                    light - dark versions.</p><span
                                                                ...
                                                                <div class="details-website"><img class="img-fluid"
                                                                    ...
                                                                    <div class="desciption-data">
                                                                        <div class="title-bookmark">
                                                                            ...
                                                                            <p class="weburl_3">
                                                                                http://themes.pixelstrap.com/multikart/back-end/{{ route('dashboard') }}
                                                                            </p>
                                                                            <div class="hover-block">
                                                                                <ul>
                                                                                    <li><a href=""
                                                ...
                                                <div class="modal-body">
                                                    <form class="form-bookmark needs-validation" novalidate="">
                                                        <div class="form-row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label>Description</label>
                                                                <textarea class="form-control" id="editdesc" required="" autocomplete="off">Tivo is beautifully crafted, clean and modern designed admin template with 6 different demos and light - dark versions.</textarea>
                                                            </div>
                                                            <div class="row">
                                                                <div class="form-group col mb-0">
                                                                    <label>Group</label>
