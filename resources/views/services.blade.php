                        ...
                        <tr class="align-middle">
                            ...
                            <td>
                                @if ($service->service_img)
                                    <div>
                                        <img src="{{ asset('storage/' . $service->service_img) }}" alt="Cover Photo"
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm">
                                    <button class="btn btn-outline-warning edit-service" data-id="{{ $service->id }}"
                                        data-img="{{ $service->service_img }}" data-name="{{ $service->name }}"
                                        data-status={{ $service->is_active }} data-duration="{{ $service->duration }}"
