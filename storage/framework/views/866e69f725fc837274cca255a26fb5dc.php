                                                ...
                                                <tr class="fade-in">
                                                    <td>
                                                        <div class="day-info">
                                                            ...
                                                            <div class="day-name"><?php echo e($daysOfWeek[$schedule->day_of_week]); ?></div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="status-container">
                                                            ...
                                                            <span class="status-badge <?php echo e($schedule->is_closed ? 'status-closed' : 'status-open'); ?>">
                                                                <i class="fas <?php echo e($schedule->is_closed ? 'fa-times-circle' : 'fa-check-circle'); ?> me-1"></i>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script>
        $(function() {
            ...
            $(document).on('click', '.save-time-btn', function() {
                ...
                let myUrl = "<?php echo e(route('vendor.schedule.updateTime', ':id')); ?>".replace(':id', scheduleId);
    ...
    `);
            ...
            $(document).on('change', '.schedule-status-toggle', function() {
                ...
                let myUrl = "<?php echo e(route('vendor.schedule.status', ':id')); ?>".replace(':id', scheduleId)
            ...
            $('#editBreakForm').on('submit', function(e) {
                ...
                let myUrl = "<?php echo e(route('vendor.break.update', ':id')); ?>".replace(':id', breakId)
            ...
            $('#breakForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('vendor.breaks.store')); ?>",
                    method: "POST",
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 200) {
            ...
            $('#scheduleForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php echo e(route('vendor.schedule.store')); ?>",
                    method: "POST",
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 200) {
            ...
            $('#exceptionForm').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "<?php echo e(route('vendor.exception.store')); ?>",
                    method: "POST",
                    data: $(this).serialize(),
                    success: function(response) {
                        if (response.status == 200) {
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/timeslots.blade.php ENDPATH**/ ?>