                            ...
                            <tbody>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-xs btn-warning editBtn" data-id="<?php echo e($category->id); ?>"
                                                data-name="<?php echo e($category->name); ?>">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <button class="btn btn-xs btn-danger deleteBtn" data-id="<?php echo e($category->id); ?>">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addServiceCategoryForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('services.categories.store')); ?>",
                    type: "POST",
                    data: $(this).serialize(),
            ...
            $('#editCategoryForm').on('submit', function(e) {
                ...
                let url_1 = "<?php echo e(route('services.categories.update', ':id')); ?>".replace(':id',
                    id);
            ...
            $('.deleteBtn').on('click', function() {
                let id = $(this).data('id');
                let url_1 = "<?php echo e(route('services.categories.destroy', ':id')); ?>".replace(':id',
                    id);
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/service_categories.blade.php ENDPATH**/ ?>