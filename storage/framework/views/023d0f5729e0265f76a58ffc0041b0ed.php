                                            ...
                                            <tr class="fade-in">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Service ID:
                                                                #<?php echo e($service->id); ?></small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <span class="price-badge">
                                                        <i class="fas fa-rupee-sign me-1"></i><?php echo e($service->price); ?>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <span><?php echo e($service->duration); ?> min</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <?php if($service->service_img): ?>
                                                        <img src="<?php echo e(asset('storage/' . $service->service_img)); ?>"
                                                ...
                                                <td>
                                                    <span
                                                        class="status-badge <?php echo e($service->is_active ? 'status-active' : 'status-inactive'); ?>">
                                                        <i
                                                            class="fas <?php echo e($service->is_active ? 'fa-check-circle' : 'fa-times-circle'); ?> me-1"></i>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button class="action-btn edit-service"
                                                            ...
                                                            data-img="<?php echo e($service->service_img); ?>"
                                                            data-name="<?php echo e($service->name); ?>"
                                                            data-status="<?php echo e($service->is_active); ?>"
                                                            data-duration="<?php echo e($service->duration); ?>"
                                                            data-price="<?php echo e($service->price); ?>" title="Edit Service">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                        <button class="action-btn btn-danger-custom delete-service"
                                                            data-id="<?php echo e($service->id); ?>" title="Delete Service">
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/services.blade.php ENDPATH**/ ?>