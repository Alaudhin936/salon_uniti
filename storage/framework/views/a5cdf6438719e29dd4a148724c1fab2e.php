                            ...
                            <div class="card-header-title">
                                ...
                                <div>
                                    ...
                                    <small style="opacity: 0.8; font-size: 0.9rem;">
                                        Total Customers: <?php echo e(count($allCustomers)); ?>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="bg-light rounded-circle p-2 me-2" style="width: 35px; height: 35px; display: flex; align-items: center; justify-content: center;">
                                                                <small class="fw-bold text-muted"><?php echo e($index + 1); ?></small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                ...
                                                                <small class="text-muted">Customer ID: #<?php echo e(str_pad($customer->id, 4, '0', STR_PAD_LEFT)); ?></small>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/customers.blade.php ENDPATH**/ ?>