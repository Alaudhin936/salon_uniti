...
<div class="container-fluid basic_table">
  <div class="row">
          ...
          <table class="table">
            ...
            <tbody>
              <tr class="border-bottom-secondary">
                <th scope="row">1</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/01.png')); ?>" alt="">Ram Jacob</td>
                <td>Wolfe</td>
              ...
              <tr class="border-bottom-success">
                <th scope="row">2</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/02.png')); ?>" alt="">John Deo</td>
                <td>Gummer</td>
              ...
              <tr class="border-bottom-info">
                <th scope="row">3</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/03.png')); ?>" alt="">Elana John</td>
                <td>Cazale	</td>
              ...
              <tr class="border-bottom-warning">
                <th scope="row">4</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/04.png')); ?>" alt="">Meryl Streep</td>
                <td>Roberts</td>
              ...
              <tr class="border-bottom-danger">
                <th scope="row">5</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/05.png')); ?>" alt="">Emma Stone</td>
                <td>Stone</td>
              ...
              <tr class="border-bottom-light"> 
                <th scope="row">6</th>
                <td> <img class="img-30 me-2" src="<?php echo e(asset('assets/images/dashboard/default/01.png')); ?>" alt="">Eliana Jons</td>
                <td>Jons</td>
    ...
    <div class="col-sm-6"> 
      <div class="card">
        <div class="card-header">
          <h4>Table head options</h4><span>Similar to tables , use the modifier classes<code>.table-[color]</code>  to make <code>thead</code>appear in any color.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive theme-scrollbar">
    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-header">
          <h4>Striped Row with Inverse Table</h4><span>Use <code>.table-striped</code> to add zebra-striping to any table row within the <code></code>. This styling doesn't work in IE8 and below as :nth-child CSS selector isn't supported.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive theme-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4>Breckpoint Specific</h4><span>Use  <code>.table-responsive.theme-scrollbar"❴-sm|-md|-lg|-xl|-xxl❵"</code> functions like a heading for a table. It helps users with screen readers to find a table and understand what it’s about and decide if they want to read it.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive theme-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4>Responsive Tables With Light Background</h4><span>A <code>.table-responsive.theme-scrollbar , .table-light</code> inside table element.</span>
        </div>
        <div class="card-block row">
          <div class="col-sm-12 col-lg-12 col-xl-12">
            <div class="table-responsive theme-scrollbar">
    ...
    <div class="col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4>Custom Table Color With Hover And Stripped</h4><span>Use class <code>table-hover, table-striped table-*table-info,table-success,table-success,table-info,table-danger,table-primary,table-secondary,table-light,table-active</code>  inside table element.</span>
        </div>
        <div class="table-responsive theme-scrollbar">
          <table class="table table-striped bg-info hover">
            <thead class="tbl-strip-thad-bdr">
              <tr>
                <th scope="col">Id</th>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/tables/bootstrap_tables/bootstrap_basic_table.blade.php ENDPATH**/ ?>