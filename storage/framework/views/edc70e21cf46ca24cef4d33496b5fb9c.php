            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="card profile-header"><img class="img-fluid bg-img-cover"
                            src="<?php echo e(asset('assets/images/user-profile/bg-profile.jpg')); ?>" alt="">
                        <div class="profile-img-wrrap"><img class="img-fluid bg-img-cover"
                                src="<?php echo e(asset('assets/images/user-profile/bg-profile.jpg')); ?>" alt=""></div>
                        <div class="userpro-box">
                            <div class="img-wrraper">
                                <div class="avatar"><img class="img-fluid" alt="" src="<?php echo e(asset('assets/images/user/7.jpg')); ?>">
                                </div><a class="icon-wrapper" href="<?php echo e(route('edit_profile')); ?>"><i
                            ...
                            <div class="user-designation">
                                ...
                                <div class="social-media">
                                    <ul class="user-list-social">
                                        ...
                                        <li><a href="https://accounts.google.com/"><i class="fa fa-google-plus"></i></a>
                                        </li>
                                        <li><a href="https://twitter.com/"><i class="fa fa-twitter"></i></a></li>
                                        <li><a href="https://www.instagram.com/"><i class="fa fa-instagram"></i></a></li>
                                        <li><a href="https://dashboard.rss.com/auth/sign-in/"><i class="fa fa-rss"></i></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="follow">
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-1.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-2.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-3.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-4.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-5.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-6.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-7.png')); ?>"></div>
                                                </li>
                                                <li>
                                                    <div class="latest-post"><img class="img-fluid" alt=""
                                                            src="<?php echo e(asset('assets/images/social-app/post-8.png')); ?>"></div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="collapse show" id="collapseicon13" data-parent="#accordion"
                                        ...
                                        <div class="card-body avatar-showcase filter-cards-view">
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/5.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/2.png')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/3.png')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/14.png')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/1.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/4.jpg')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/11.png')); ?>" alt="#"></div>
                                            <div class="d-inline-block friend-pic"><img class="img-50 rounded-circle"
                                                    src="<?php echo e(asset('assets/images/user/8.jpg')); ?>" alt="#"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="profile-post">
                                    <div class="post-header">
                                        <div class="d-flex"><img class="img-thumbnail rounded-circle me-3"
                                                src="<?php echo e(asset('assets/images/user/7.jpg')); ?>" alt="Generic placeholder image">
                                            <div class="flex-grow-1 align-self-center"><a href="<?php echo e(route('social_app')); ?>">
                                    ...
                                    <div class="post-body">
                                        <div class="img-container">
                                            <div class="my-gallery" itemscope="">
                                                <figure itemprop="associatedMedia" itemscope=""><a
                                                        href="<?php echo e(asset('assets/images/user-profile/post1.jpg')); ?>"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/user-profile/post1.jpg')); ?>"
                                        ...
                                        <div class="post-react">
                                            <ul>
                                                <li><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/3.jpg')); ?>"
                                                        alt=""></li>
                                                <li><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/5.jpg')); ?>"
                                                        alt=""></li>
                                                <li><img class="rounded-circle" src="<?php echo e(asset('assets/images/user/1.jpg')); ?>"
                                                        alt=""></li>
                                            </ul>
                                        ...
                                        <div class="img-container">
                                            <div class="row mt-4 pictures my-gallery" itemscope="">
                                                <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                                        href="<?php echo e(asset('assets/images/user-profile/post2.jpg')); ?>"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/user-profile/post2.jpg')); ?>"
                                                            itemprop="thumbnail" alt="gallery"></a>
                                                    <figcaption itemprop="caption description">Image caption 1</figcaption>
                                                </figure>
                                                <figure class="col-sm-6" itemprop="associatedMedia" itemscope=""><a
                                                        href="<?php echo e(asset('assets/images/user-profile/post3.jpg')); ?>"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/user-profile/post3.jpg')); ?>"
                                                            itemprop="thumbnail" alt="gallery"></a>
                                ...
                                <div class="profile-post">
                                    ...
                                    <div class="post-body">
                                        <div class="img-container">
                                            <div class="my-gallery" itemscope="">
                                                <figure itemprop="associatedMedia" itemscope=""><a
                                                        href="<?php echo e(asset('assets/images/user-profile/post4.jpg')); ?>"
                                                        itemprop="contentUrl" data-size="1600x950"><img class="img-fluid"
                                                            src="<?php echo e(asset('assets/images/user-profile/post4.jpg')); ?>"
                                                            itemprop="thumbnail" alt="gallery"></a>
                                                    <figcaption itemprop="caption description">Image caption 1</figcaption>
                                                </figure>
                                            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/users/user_profile.blade.php ENDPATH**/ ?>