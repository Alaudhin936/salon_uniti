<div class="page-header">
        ...
        <div class="left-menu-header">
          ...
          <ul class="header-left">
            <li class="onhover-dropdown"><span class="f-w-600">Dashboard</span><span><i class="middle"
              ...
              <ul class="onhover-show-div left-dropdown">
                <li> <a href="<?php echo e(route('dashboard')); ?>">Default</a></li>
                <li> <a href="<?php echo e(route('ecommerce_dashboard')); ?>"> Ecommerce</a></li>
              </ul>
            </li>
              ...
              <ul class="onhover-show-div left-dropdown">
                <li class="flyout-right"><a href="javascript:void(0)">Project</a>
                  <ul>
                    ...
                    <li> <a href="<?php echo e(route('project_create')); ?>">Project Create</a></li>
                  </ul>
                </li>
                <li><a href="<?php echo e(route('file_manager')); ?>">File manager</a></li>
                <li><a href="<?php echo e(route('kanban')); ?>">kanban</a></li>
                ...
                <li class="flyout-right"><a href="javascript:void(0)">Users</a>
                  <ul>
                    <li> <a href="<?php echo e(route('user_profile')); ?>">User Profile</a></li>
                    <li> <a href="<?php echo e(route('edit_profile')); ?>">Users Edit</a></li>
                    <li> <a href="<?php echo e(route('user_cards')); ?>">User Cards</a></li>
                  </ul>
                </li>
                <li><a href="<?php echo e(route('bookmark')); ?>">Bookmarks</a></li>
                <li><a href="<?php echo e(route('contacts')); ?>">Contacts</a></li>
                <li><a href="<?php echo e(route('social_app')); ?>">Social App</a></li>
              </ul>
            </li>
            <li class="onhover-dropdown"> <span class="f-w-600">More pages</span><span><i class="middle"
                  data-feather="chevron-down"></i></span>
              <ul class="onhover-show-div left-dropdown">
                <li><a href="<?php echo e(route('landing_page')); ?>">Landing Page</a></li>
                <li><a href="<?php echo e(route('sample_page')); ?>">Sample Page</a></li>
                <li><a href="<?php echo e(route('internationalization')); ?>">Internationalization</a></li>
        ...
        <ul class="nav-menus">
              ...
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="<?php echo e(route('order_history')); ?>">Delivery processing </a><span class="pull-right">6 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="<?php echo e(route('cart')); ?>">Order Complete</a><span class="pull-right">3 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="<?php echo e(route('invoice_template')); ?>">Tickets Generated</a><span class="pull-right">1 hr</span></p>
                  </div>
                </div>
              </li>
              <li>
                <div class="d-flex align-items-center">
                  ...
                  <div class="flex-grow-1">
                    <p><a href="<?php echo e(route('email_inbox')); ?>">Delivery Complete</a><span class="pull-right">45 min</span></p>
                  </div>
                </div>
              </li>
            ...
            <ul class="message-dropdown onhover-show-div">
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt=""></div>
                  <div class="flex-grow-1">
                    <h5 class="mb-0"> <a href="<?php echo e(route('email_inbox')); ?>">Emay Walter</a></h5>
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt=""></div>
                  <div class="flex-grow-1">
                    <h5 class="mb-0"> <a href="<?php echo e(route('email_inbox')); ?>">Jason Borne</a></h5>
              ...
              <li>
                <div class="d-flex align-items-start">
                  <div class="message-img bg-light-primary"><img src="<?php echo e(asset('assets/images/user/10.jpg')); ?>" alt=""></div>
                  <div class="flex-grow-1">
                    <h5 class="mb-0"> <a href="<?php echo e(route('email_inbox')); ?>">Sarah Loren</a></h5>
                    <p>What`s the project report update?</p>
                  </div>
                  <div class="notification-right"><i data-feather="x"></i></div>
                </div>
              </li>
              <li><a class="btn btn-primary" href="<?php echo e(route('email_inbox')); ?>">Check Messages</a></li>
            </ul>
          </li>
          ...
          <li class="profile-nav onhover-dropdown">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="<?php echo e(route('user_profile')); ?>"><i data-feather="user"></i><span>Account</span></a></li>
              <li><a href="<?php echo e(route('email_inbox')); ?>"><i data-feather="mail"></i><span>Inbox</span></a></li>
              <li><a href="<?php echo e(route('edit_profile')); ?>"><i data-feather="settings"></i><span>Settings</span></a></li>
              <li><a href="<?php echo e(route('login')); ?>"><i data-feather="log-in"> </i><span>Log in</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
  ...
  </div><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/layout/header.blade.php ENDPATH**/ ?>