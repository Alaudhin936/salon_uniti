                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h3 class="mb-2 fw-bold text-dark">
                            ...
                            Available Slots for <?php echo e($date); ?>
                    ...
                    <div class="col-12">
                        <div class="d-flex flex-wrap gap-3">
                            <?php $__empty_1 = true; $__currentLoopData = $slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <button
                                    class="btn
                        <?php echo e($slot['isBooked'] ? 'btn-secondary' : ($slot['isPast'] ? 'btn-dark' : 'btn-success')); ?>

                        btn-time-slot"
                                    <?php echo e($slot['isBooked'] || $slot['isPast'] ? 'disabled' : ''); ?>

                                    data-start="<?php echo e($slot['start_time']); ?>" data-end="<?php echo e($slot['end_time']); ?>">

                                    <div class="text-center">
                                        <div class="time-main"><?php echo e($slot['time']); ?></div>
                                        <div class="time-duration">
                                            <?php if($slot['isBooked']): ?>
                                                Booked
                                            <?php elseif($slot['isPast']): ?>
                                                Expired
                                            <?php else: ?>
                                                Available
                                            <?php endif; ?>
        ...
        $(document).ready(function() {
            ...
            $('.btn-time-slot:not(:disabled)').click(function() {
                ...
                selectedSlot = {
                    ...
                    service_id: '<?php echo e($serviceId); ?>',
                    user_id: '<?php echo e($userId); ?>'
                };
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/bookings.blade.php ENDPATH**/ ?>