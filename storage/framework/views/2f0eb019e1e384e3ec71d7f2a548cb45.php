                                                ...
                                                <?php $__currentLoopData = $salonTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="fade-in">
                                                        <td class="text-center">
                                                            <span class="id-badge"><?php echo e($type->id); ?></span>
                                                        </td>
                                                        <td>
                                                            <div class="name-content">
                                                                ...
                                                                <div>
                                                                    <div class="fw-semibold"><?php echo e($type->name); ?></div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#editSalonTypeForm").submit(function(e) {
                ...
                const myUrl = "<?php echo e(route('admin.salon.types.edit', ':id')); ?>".replace(':id', salon_type_id);
            ...
            $(document).on("click", ".deleteBtn", function() {
                ...
                const myUrl = "<?php echo e(route('admin.salon.types.delete', ':id')); ?>".replace(':id', id);
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\salon_unitiii\resources\views/salon_types.blade.php ENDPATH**/ ?>